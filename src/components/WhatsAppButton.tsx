...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-24 right-6 md:bottom-8 md:right-8 z-[9999] bg-[#25D366] text-white p-3.5 sm:p-4 rounded-full shadow-2xl hover:bg-[#20ba5a] transition-all duration-300 hover:scale-110 flex items-center justify-center group"
